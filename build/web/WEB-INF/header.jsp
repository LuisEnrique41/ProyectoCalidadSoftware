						...
						<div class="btn-group pull-right">
							<div class="btn-group">
								...
								<ul class="dropdown-menu">
									<li><a href="CambiarMonedas?moneda=MXN">Pesos Mexicanos (MXN)</a></li>
                                                                        <li><a href="CambiarMonedas?moneda=COP">Pesos Colombianos (COP)</a></li>
                                                                        <li><a href="CambiarMonedas?moneda=USD">Dolar USA (USD)</a></li>
									<li><a href="CambiarMonedas?moneda=PEN">Sol Peruano (PEN)</a></li>
